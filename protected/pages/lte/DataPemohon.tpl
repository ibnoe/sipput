...
<com:TPanel CssClass="row" Visible="<%=$this->dataPengajuan['Status']=='perusahaan'%>">
    <div class="col-md-12">
        <div class="box box-solid box-success">
            <div class="box-header">
                <h3 class="box-title"><i class="fa fa-square-o"></i> Profil Perusahaan</h3>
                <div class="box-tools pull-right">
                    <button data-widget="collapse" class="btn btn-success btn-sm" onclick="JavaScript:return false;">
                        <i class="fa fa-minus"></i>
                    </button>
                ...
                <div class="row">
                    <div class="col-md-6">                    
                        <div class="form-group">
                            <label class="col-sm-3 control-label">ID</label>
                            <div class="col-sm-9">
                                <p class="form-control-static"><%=$this->dataPengajuan['NmCom']%></p>
                            </div>                            
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Nama</label>
