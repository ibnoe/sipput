...
class CAreaPenangkapan extends MainPageSA {
	public function onLoad($param) {		
		...
		if (!$this->IsPostBack&&!$this->IsCallBack) {
            if (!isset($_SESSION['currentPageAreaPenangkapan'])||$_SESSION['currentPageAreaPenangkapan']['page_name']!='sa.lokasi.AreaPenangkapan') {
                $_SESSION['currentPageAreaPenangkapan']=array('page_name'=>'sa.lokasi.AreaPenangkapan','page_num'=>0,'search'=>false);												
			}     
    ...
    public function saveData($sender,$param) {		
        if ($this->Page->IsValid) {		
            ...
            $this->redirect('lokasi.AreaPenangkapan',true);
        }
	}
