...
class CPemohon extends MainPageSA {
    ...
    private function populateData ($search=false) {    
        ...
        if ($search) {
            ...
            $str = "SELECT RecNoPem,NmPem,KtpPem,TelpPem,Foto,nama_uptd,DateAdded FROM pemohon p";
            ...
            $str = "SELECT RecNoPem,NmPem,KtpPem,TelpPem,Foto,nama_uptd,DateAdded FROM pemohon p$str_iduptd";
