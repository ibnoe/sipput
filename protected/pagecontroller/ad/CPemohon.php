...
class CPemohon extends MainPageSA {
    ...
    private function populateData ($search=false) {
        ...
        $str = "SELECT pe.RecNoPem,idCom,NmPem,RecStsCom,AlmtPem,TelpPem,Foto,Status,DateAdded FROM pemohon pe LEFT JOIN perusahaan p ON (p.RecNoPem=pe.RecNoPem) WHERE pe.iduptd=$iduptd";
        if ($search) {
        ...
        $this->DB->setFieldTable(array('RecNoPem','idCom','NmPem','RecStsCom','AlmtPem','TelpPem','Foto','Status','DateAdded'));
    ...
    public function editRecord ($sender,$param) {
        ...
        $str = "SELECT NmPem,KtpPem,AlmtPem,TelpPem,NpwpPem,Foto,Status FROM pemohon WHERE RecNoPem=$recnopem";
        $this->DB->setFieldTable(array('NmPem','KtpPem','AlmtPem','TelpPem','NpwpPem','Foto','Status'));
